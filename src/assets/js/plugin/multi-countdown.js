    ...
    function dateReplace(extraClass, date, fixTime, initText, zeroPad) {
        ...
        if (dif[0] < 0 || dif[1] < 0 || dif[2] < 0 || dif[3] < 0) {
            ...
            if (endText != undefined) { //case data-endText attr
                ...
                document.getElementById("ended-text-inner-1").innerHTML = "پیشنهاد ویژه این محصول به پایان رسیده!";
                document.getElementById("ended-text-inner-2").innerHTML = "پیشنهاد ویژه این محصول به پایان رسیده!";
                document.getElementById("ended-text-inner-3").innerHTML = "پیشنهاد ویژه این محصول به پایان رسیده!";
                document.getElementById("ended-text-inner-4").innerHTML = "پیشنهاد ویژه این محصول به پایان رسیده!";
                document.getElementById("blurEnd-1").style.filter = "blur(2px)";
                document.getElementById("blurEnd-2").style.filter = "blur(2px)";
                document.getElementById("blurEnd-3").style.filter = "blur(2px)";
                document.getElementById("blurEnd-4").style.filter = "blur(2px)";
            }
